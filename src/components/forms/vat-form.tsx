...
import { formatCurrency, getQuarterDates } from "@/lib/tax-calculations";
          ...
          {currentStep === 1 && (
            <>
              <CardHeader>
                ...
                <CardDescription>Your details as a Próspera retail business operator.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          {currentStep === 2 && (
            <>
              <CardHeader>
                ...
                <CardDescription>Select the quarter you are filing for.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  control={form.control}
          ...
          {currentStep === 3 && (
            <>
              <CardHeader>
                ...
                <CardDescription>Report your total retail sales for Q{quarter} {taxYear}.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="bg-green-50 rounded-lg p-4 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <span className="font-bold text-green-900">{formatCurrency(vatCalculation.baseVatOwed)}</span>
                  </div>
          ...
          {currentStep === 4 && (
            <>
              <CardHeader>
                ...
                <CardDescription>Enter any VAT credits from previous periods.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  control={form.control}
              ...
              <CardContent className="space-y-6">
                <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-xl text-green-600">{formatCurrency(vatCalculation.totalDue)}</span>
                  </div>
                </div>
