  ...
  return (
    <div className="min-h-screen bg-white flex flex-col print:min-h-0">
      ...
      <div className="bg-slate-50 border-b print:hidden">
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className={`px-3 py-1 rounded-full text-sm font-medium ${statusColors[vatReturn.status]}`}>
              {statusLabels[vatReturn.status]}
            </div>
          </div>
      ...
      <main className="flex-1 container mx-auto px-6 py-8 max-w-3xl print:py-0 print:max-w-none">
          ...
          <div className="px-6 py-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="font-medium text-slate-900">{vatReturn.user?.name || "N/A"}</p>
              </div>
              <div>
                <p className="text-slate-500">(e)Resident Permit Number</p>
                <p className="font-medium text-slate-900">{vatReturn.user?.residentId || "N/A"}</p>
              </div>
              <div>
                <p className="text-slate-500">Period</p>
                <p className="font-medium text-slate-900">Q{vatReturn.quarter} {vatReturn.taxYear}</p>
              </div>
              <div>
        ...
        <div className="border rounded-lg mb-6 print:shadow-none">
          <div className="px-6 py-4 border-b bg-slate-50 print:bg-white">
            <h2 className="font-semibold text-slate-900">Retail Value Added Tax Calculation</h2>
          </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="grid grid-cols-3 gap-2 bg-white p-2 rounded print:bg-slate-50">
                  <span className="col-span-2 text-slate-700">
                    ...
                    <br />
                    <span className="text-xs text-slate-500">50% of Line 1</span>
                  </span>
                ...
                {/* Line 3 */}
                <div className="grid grid-cols-3 gap-2 bg-green-100 p-2 rounded print:bg-slate-100">
                  <span className="col-span-2 text-slate-700">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <span className="col-span-2 text-slate-700">
                    ...
                    <br />
                    <span className="text-xs text-slate-500">Cannot exceed amount in Line 3</span>
                  </span>
                  <span className="text-right font-medium text-green-600">
