      ...
      <main className="flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">Access your tax filing account</p>
          </div>
          ...
          <div className="border rounded-lg p-6 space-y-6">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border rounded font-medium text-slate-700 hover:bg-slate-50 transition-colors disabled:opacity-50"
            >
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-slate-900 text-white rounded font-medium hover:bg-slate-800 transition-colors disabled:opacity-50"
              >
            ...
            <div className="pt-2 border-t">
              <button
                ...
                disabled={isLoading}
                className="w-full text-xs text-slate-400 hover:text-slate-600 transition-colors disabled:opacity-50 py-2"
              >
          ...
          <p className="text-center text-xs text-slate-500 mt-6">
            By signing in, you agree to the Próspera ZEDE terms of service.
          </p>
        </div>
      </main>
    </div>
